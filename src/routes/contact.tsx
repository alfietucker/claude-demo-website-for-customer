...
function Contact() {
  ...
  useEffect(() => {
    document.title = "Contact Apex Roofing Perth | Get Your Free Roofing Quote";
  }, []);
      ...
      <section className="py-16 md:py-24 bg-cream border-b border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            title="Free quote within 2 business hours"
            subtitle="Tell us about your roof. A real Perth roofer will be in touch — no call centres, no chasing."
          />
        </div>
      </section>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="rounded-2xl bg-white border border-border p-6">
              ...
              <div className="mt-4 space-y-3 text-sm">
                <a href={site.phoneHref} className="flex items-center gap-3 hover:text-primary">
                  <Phone className="w-5 h-5 text-primary" />
                  <span>
                    <span className="block text-xs text-muted-foreground">Phone (24/7 emergency)</span>
                    <span className="font-semibold text-charcoal">{site.phone}</span>
                  </span>
                </a>
                <a href={`mailto:${site.email}`} className="flex items-center gap-3 hover:text-primary">
                  ...
                  <span>
                    ...
                    <span className="font-semibold text-charcoal">{site.email}</span>
                  </span>
                </a>
                <p className="flex items-center gap-3">
                  ...
                  <span>
                    ...
                    <span className="font-semibold text-charcoal">{site.address}</span>
                  </span>
                </p>
                <p className="flex items-center gap-3">
                  ...
                  <span>
                    ...
                    <span className="font-semibold text-charcoal">{site.hours}</span>
                  </span>
                </p>
              </div>
            </div>
